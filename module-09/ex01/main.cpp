...
int main(int ac, char **av) {
  ...
  for (size_t i = 0; i != (sizeof RPN_value / sizeof *RPN_value); i++) {
    ...
    std::cout << "Value " << i + 1 << "/"
              << sizeof RPN_value / sizeof *RPN_value << " : " << RPN_value[i]
              << " = ";
  ...
  std::string incorrent_RPN_value[] = {"(1 + 1)",
                                       "toto",
                                       "",
                                       "1 +",
                                       "11+",
                                       ...
                                       "5 6 + 7 8 - 9 10 / *"};
  for (size_t i = 0;
       i != (sizeof incorrent_RPN_value / sizeof *incorrent_RPN_value); i++) {
    RPN PNL(incorrent_RPN_value[i].c_str());
    std::cout << "Value " << i + 1 << "/"
              << sizeof incorrent_RPN_value / sizeof *incorrent_RPN_value
